      ...
      <div className="space-y-6 sm:space-y-8">
        {experience.map((job, index) => (
          <React.Fragment key={index}>
            <div className={`${isDarkTheme ? 'bg-gray-800/50' : 'bg-white'} shadow-lg backdrop-blur-sm rounded-lg p-4 sm:p-6 transform transition-all duration-300 hover:scale-105`}>
